  ...
  <?php $form = ActiveForm::begin([
    ...
    <?= $form
      ...
      <div class="d-flex align-items-center gap-2 ms-auto">
          <label class="control-label" for="searchPurchaseOrderList">Search</label>
...
<?php
$js = <<<JS
$(document).on('keyup', '#searchPurchaseOrderList', function() {
  var form = $(this).closest('form');
  clearTimeout(window.searchPurchaseOrderTimeout);
  window.searchPurchaseOrderTimeout = setTimeout(function() {
    form.trigger('submit');
  }, 500);
});
JS;
