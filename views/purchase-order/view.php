              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  <div class="mb-3">
                    ...
                    <?php endif; ?>
                    <h3 class="fw-bold mb-0">បញ្ជាទិញ - Purchase Order</h3>
                  </div>
                ...
                <div class="flex-shrink-0 mt-sm-0 mt-3 text-end">
                  <div class="mb-4 d-print-none" data-html2canvas-ignore="true">
                    <?php if (
                      ...
                      $model->status != \app\models\PurchaseOrder::STATUS_PAID
                    ): ?>
                      <?= Html::a(
                  ...
                  <?php else: ?>
                      <?= Html::button(
                        ...
                        [
                          ...
                          'title' =>
                            'Purchase Order is not editable after cancel/paid.',
                        ],
                      ) ?>
                  <?php endif; ?>
                  <?= Html::a(
                  ...
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                          <li>
                              ...
                              ) ?>" data-action-title="Duplicate Purchase Order" data-action-text="This will create a new purchase order draft with the same items. Continue?">Duplicate</a>
                          </li>
                          <li>
                              <a class="dropdown-item purchase-order-action" href="#" data-action-url="<?= Url::to(
            ...
            <div class="card-body p-4">
              <div class="row g-3">
                <div class="col-lg-3 col-6">
                  ...
                  <h5 class="fs-14 mb-0">#<span id="purchase-order-no"><?= Html::encode(
                    $model->code,
                  ) ?></span></h5>
                </div>
                <div class="col-lg-3 col-6">
                ...
                <div class="col-lg-3 col-6">
                  ...
                  <h5 class="fs-14 mb-0 text-danger"><span id="purchase-order-due-date"><?= date(
                    'd M, Y',
