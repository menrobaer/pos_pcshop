                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    ...
                                                    ) ?>" data-action-title="Convert To Invoice" data-action-text="This will create an invoice from this quotation. Please review details before proceeding.">Convert to Invoice</a>
                                                </li>
                                            </ul>
                                        </div>
