...
<div class="product-source-form">
  ...
  <?= $form
    ...
    <div class="form-check form-switch">{input}<label class="form-check-label" for="checkbox-source-status">Active</label></div>{error}{hint}',
    ])
    ->checkbox(
      [
        'class' => 'form-check-input',
        'role' => 'switch',
        'id' => 'checkbox-source-status',
        'label' => false,
      ],
      false,
    ) ?>
  ...
  <div class="d-flex mt-4 gap-3">
    ...
    <?= Html::submitButton(
      $model->isNewRecord ? 'Save Source' : 'Save Changes',
