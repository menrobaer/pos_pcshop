...
/** @var app\models\ProductDescriptionSearch $searchModel */
...
<div class="product-description-index">
  <?php Pjax::begin(['id' => 'product-description-pjax-container']); ?>
  <div class="card">
    <div class="card-body">
        ...
        <div class="row g-4">
          <div class="col-sm-auto">
            <div class="d-flex gap-2">
              <?= Html::button(
                '<i class="ri-add-line align-bottom me-1"></i> Add Description',
                [
                  'class' => 'btn btn-success',
                  'data' => [
                    'bs-toggle' => 'modal',
                    'bs-target' => '#modal-product-description',
      ...
      <?= GridView::widget([
        ...
        'tableOptions' => [
          'id' => 'table-product-description-list',
          'class' =>
              ...
              'update' => function ($url, $model) {
                return Html::button('<i class="ri ri-pencil-line"></i>', [
                  ...
                  'data' => [
                    'bs-toggle' => 'modal',
                    'bs-target' => '#modal-product-description',
                    'title' => 'Update Description : ' . $model->name,
                ...
                if ($model->isUsed()) {
                  return Html::button(
                    ...
                    [
                      ...
                      'data-pjax-container' =>
                      '#product-description-pjax-container',
                    ],
                  );
                }
                return Html::a(
                  ...
                  [
                    ...
                    'data-pjax' => '0',
                    'data-name' => $model->name,
                    'data-pjax-container' => '#product-description-pjax-container',
                  ],
                );
              },
            ],
