...
/** @var app\models\ProductConditionSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Product Conditions';
$this->params['breadcrumbs'][] = $this->title;

echo \app\widgets\Modal::widget([
  'id' => 'modal-product-condition',
  'size' => 'modal-md',
]);
?>
<div class="product-condition-index">
  <?php Pjax::begin(['id' => 'product-condition-pjax-container']); ?>
  <div class="card">
    <div class="card-body">
            ...
            <div class="d-flex gap-2">
              <?= Html::button(
                ...
                [
                  ...
                  'data' => [
                    'bs-toggle' => 'modal',
                    'bs-target' => '#modal-product-condition',
      ...
      <?= GridView::widget([
        ...
        'tableOptions' => [
          'id' => 'table-product-condition-list',
              ...
              'update' => function ($url, $model) {
                return Html::button('<i class="ri ri-pencil-line"></i>', [
                  ...
                  'data' => [
                    'bs-toggle' => 'modal',
                    'bs-target' => '#modal-product-condition',
                    'title' => 'Update Condition : ' . $model->name,
                ...
                if ($model->isUsed()) {
                  return Html::button(
                    ...
                    [
                      ...
                      'data-pjax-container' => '#product-condition-pjax-container',
                    ],
                  );
                }
                return Html::a(
