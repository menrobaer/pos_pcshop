  ...
  <div id="scrollbar">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link menu-link <?= $isPeople ? 'active' : '' ?>" href="#sidebarPeople" data-bs-toggle="collapse" role="button" aria-expanded="<?= $isPeople ? 'true' : 'false' ?>" aria-controls="sidebarPeople">
        ...
        <li class="nav-item">
          <a class="nav-link menu-link <?= $isReport ? 'active' : '' ?>" href="#sidebarReports" data-bs-toggle="collapse" role="button" aria-expanded="<?= $isReport ? 'true' : 'false' ?>" aria-controls="sidebarReports">
        ...
        <li class="nav-item">
          <a class="nav-link menu-link <?= $isSetting ? 'active' : '' ?>" href="#sidebarSettings" data-bs-toggle="collapse" role="button" aria-expanded="<?= $isSetting ? 'true' : 'false' ?>" aria-controls="sidebarSettings">
